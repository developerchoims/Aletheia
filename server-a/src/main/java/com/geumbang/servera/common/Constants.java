...
public class Constants {
    ...
    public static final String USER_NOT_FOUND = "해당 아이디를 찾을 수 없습니다.";
    ...
    public static String JWT_EXCEPTION = "JWT인증 오류입니다.";
    public static String LOGIN_SUCCESS = "로그인에 성공하였습니다.";
    public static String ORDER_EXCEPTION = "주문 정보를 불러올 수 없습니다.";
